...
// זז ל-15% במובייל כדי להראות את הפרצוף שלם, וחוזר למרכז המקורי מ-sm ומעלה.
export function Hero({ hero }: { hero: SiteContent["hero"] }) {
  return (
    ...
    >
      {/* רקע האיור (Gemini). object-[15%_50%] שומר את הפרצוף שלם במובייל,
          sm:object-center חוזר למרכז המקורי מ-sm ומעלה */}
      <Image
        ...
        priority
        sizes="100vw"
        className="object-cover object-[15%_50%] sm:object-center"
        aria-hidden
      />
      ...
      <div className="relative z-10 flex flex-col items-center">
        <p className="mb-2 text-xs font-bold uppercase tracking-[0.3em] text-cyan drop-shadow-[0_1px_6px_rgba(11,4,32,0.9)] sm:mb-4">
          {hero.eyebrow}
        </p>
        ...
        <p className="mt-3 max-w-xl text-base text-cream/85 drop-shadow-[0_1px_8px_rgba(11,4,32,0.95)] sm:mt-6 sm:text-lg">
          {hero.tagline}
        </p>
        <a
          href={hero.ctaHref}
          className={cn(
            ...
            "mt-4 h-12 gap-2 rounded-full px-8 text-base sm:mt-8"
          )}
        >
